...
public class ques4_activity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    AppCompatButton b1;
    AppCompatButton  b2;
    AppCompatButton  b3;
    AppCompatButton  b4;
        ...
        }else
        {
            ...
            builder.setItems(options, new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    if (which == 0) {
                        mAuth.signOut();
                        Intent mainIntent = new Intent(ques4_activity.this, MainActivity.class);
                        startActivity(mainIntent);
                        finish();

                    }
                    if (which == 1) {
                        Toast.makeText(ques4_activity.this,"Back Button Pressed",Toast.LENGTH_LONG).show();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.navigation_drawer4);
        ...
        final Intent intent=new Intent(ques4_activity.this,ques5_activity.class);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("ques4",""+(res_int+1));
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch(id)
        {
            case R.id.logout:
                ...
                break;
            case R.id.settings:
                Intent settingIntent=new Intent(ques4_activity.this,ScoreCardActivity.class);
                startActivity(settingIntent);
                break;
            case R.id.scorecard:
                Toast.makeText(getApplicationContext(),"Indox",Toast.LENGTH_SHORT).show();
                Intent scoreIntent=new Intent(ques4_activity.this,ScoreCardActivity.class);
