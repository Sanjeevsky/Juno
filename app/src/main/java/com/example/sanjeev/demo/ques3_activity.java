...
public class ques3_activity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    AppCompatButton b1;
    AppCompatButton  b2;
    AppCompatButton  b3;
    AppCompatButton  b4;
        ...
        }else
        {
            ...
            builder.setItems(options, new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    if (which == 0) {
                        mAuth.signOut();
                        Intent mainIntent = new Intent(ques3_activity.this, MainActivity.class);
                        startActivity(mainIntent);
                        finish();

                    }
                    if (which == 1) {
                        Toast.makeText(ques3_activity.this,"Back Button Pressed",Toast.LENGTH_LONG).show();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.navigation_drawer3);
        ...
        final Intent intent=new Intent(ques3_activity.this,ques4_activity.class);
        ...
        result=bundle.getString("ques2");
        final int res_int=Integer.parseInt(result);
        Toast.makeText(getApplicationContext(),""+res_int,Toast.LENGTH_SHORT).show();
        b1.setOnClickListener(new View.OnClickListener() {
            @RequiresApi(api = Build.VERSION_CODES.JELLY_BEAN)
            @Override
            public void onClick(View v) {
                b1.setBackground(red);
                intent.putExtra("ques3",""+(res_int));
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                b2.setBackground(green);
                intent.putExtra("ques3",""+(res_int+1));
                startActivity(intent);
            }
        });
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch(id)
        {
            case R.id.logout:
                ...
                break;
            case R.id.settings:
                Intent settingIntent=new Intent(ques3_activity.this,ScoreCardActivity.class);
                startActivity(settingIntent);
                break;
            case R.id.scorecard:
                Toast.makeText(getApplicationContext(),"Indox",Toast.LENGTH_SHORT).show();
                Intent scoreIntent=new Intent(ques3_activity.this,ScoreCardActivity.class);
