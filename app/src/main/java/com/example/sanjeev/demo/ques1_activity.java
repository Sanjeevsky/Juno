...
public class ques1_activity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    AppCompatButton b1;
    AppCompatButton  b2;
    AppCompatButton  b3;
    AppCompatButton  b4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Intent intent=new Intent(ques1_activity.this,ques2_activity.class);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch(id)
        {
            case R.id.logout:
                ...
                mAuth.signOut();
                Intent mainIntent=new Intent(ques1_activity.this,MainActivity.class);
                startActivity(mainIntent);
                break;
            case R.id.settings:
                Intent settingIntent=new Intent(ques1_activity.this,SettingsActivity.class);
                startActivity(settingIntent);
                break;
            case R.id.scorecard:
                Toast.makeText(getApplicationContext(),"Indox",Toast.LENGTH_SHORT).show();
                Intent scoreIntent=new Intent(ques1_activity.this,ScoreCardActivity.class);
        ...
        }else
        {
            ...
            builder.setItems(options, new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    if (which == 1) {
                        Toast.makeText(ques1_activity.this,"Back Button Pressed",Toast.LENGTH_LONG).show();
