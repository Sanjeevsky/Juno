...
public class ques7_activity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    AppCompatButton b1;
    AppCompatButton  b2;
    AppCompatButton  b3;
    AppCompatButton  b4;
        ...
        }else
        {
            ...
            builder.setItems(options, new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    if (which == 0) {
                        mAuth.signOut();
                        Intent mainIntent = new Intent(ques7_activity.this, MainActivity.class);
                        startActivity(mainIntent);

                    }
                    if (which == 1) {
                        Toast.makeText(ques7_activity.this,"Back Button Pressed",Toast.LENGTH_LONG).show();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.navigation_drawer7);
        ...
        final Intent intent=new Intent(ques7_activity.this,ques8_activity.class);
        ...
        b4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                b4.setBackground(green);
                intent.putExtra("ques7",""+(res_int+1));
                startActivity(intent);
            }
        });
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch(id)
        {
            case R.id.logout:
                ...
                break;
            case R.id.settings:
                Intent settingIntent=new Intent(ques7_activity.this,ScoreCardActivity.class);
                startActivity(settingIntent);
                break;
            case R.id.scorecard:
                Toast.makeText(getApplicationContext(),"Indox",Toast.LENGTH_SHORT).show();
                Intent scoreIntent=new Intent(ques7_activity.this,ScoreCardActivity.class);
